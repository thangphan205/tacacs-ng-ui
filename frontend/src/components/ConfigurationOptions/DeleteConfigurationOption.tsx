...
const DeleteConfigurationOption = ({ configuration_option }: { configuration_option: ConfigurationOptionPublic }) => {
  ...
  const deleteConfigurationOption = async (id: string) => {
    await ConfigurationOptionsService.deleteConfigurationOption({ id: id })
  }

  const mutation = useMutation({
    mutationFn: deleteConfigurationOption,
    onSuccess: () => {
  ...
  const onSubmit = async () => {
    mutation.mutate(configuration_option.id)
  }
...
export default DeleteConfigurationOption
