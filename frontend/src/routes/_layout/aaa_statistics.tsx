...
export function AaaStatistics() {
  ...
  const data_authentication_success_count_by_user =
    stats?.today_authentication_success_count_by_user?.map((user, index) => ({
      name: user.username,
  ...
  const data_authentication_success_count_by_nas_ip =
    stats?.today_authentication_success_count_by_nas_ip?.map((user, index) => ({
      name: user.nas_ip,
      value: user.success_count,
      color: color_chart[index],
    })) || []
  ...
  const data_authentication_failed_count_by_user =
    stats?.today_authentication_failed_count_by_user?.map((user, index) => ({
      name: user.username,
          ...
          <GridItem colSpan={1}>
            <Box p={2} borderWidth="1px" borderRadius="lg" h="100%">
              <Stat.Root>
                ...
                <Stat.ValueText>
                  {stats?.today_unique_user_source_ip_count}
                </Stat.ValueText>
              </Stat.Root>
            </Box>
          </GridItem>
          <GridItem colSpan={1}>
            <Box p={2} borderWidth="1px" borderRadius="lg" h="100%">
              <Stat.Root>
                ...
                <Stat.ValueText>
                  {stats?.today_unique_nas_ip_count}
                </Stat.ValueText>
              </Stat.Root>
            </Box>
          </GridItem>
          <GridItem colSpan={1}>
            <Box p={2} borderWidth="1px" borderRadius="lg" h="100%">
              <Stat.Root>
                ...
                <Stat.ValueText
                  color={
                    stats?.today_failed_logins && stats?.today_failed_logins > 0
                      ? "red"
                      : "green"
                  }
                >
