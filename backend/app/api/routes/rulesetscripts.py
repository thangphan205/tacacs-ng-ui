...
def read_rulesetscripts(
    ...
    if search:
        f = (
            RulesetScript.condition.ilike(f"%{search}%")
            | RulesetScript.key.ilike(f"%{search}%")
            | RulesetScript.value.ilike(f"%{search}%")
            | RulesetScript.description.ilike(f"%{search}%")
        )
