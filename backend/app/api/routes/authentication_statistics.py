...
router = APIRouter(prefix="/authentication_statistics", tags=["authentication_statistics"])
...
@router.get("/", dependencies=[Depends(get_current_user)], response_model=AuthenticationStatisticsPublic)
