...
def read_profilescripts(
    ...
    if search:
        f = (
            ProfileScript.condition.ilike(f"%{search}%")
            | ProfileScript.key.ilike(f"%{search}%")
            | ProfileScript.value.ilike(f"%{search}%")
            | ProfileScript.description.ilike(f"%{search}%")
        )
